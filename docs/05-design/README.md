...
*Рисунок 5.1 — Диаграмма последовательности — Вход в систему (UC-01)*
...
*Рисунок 5.2 — Диаграмма последовательности — Создание заказа (UC-10)*
...
*Рисунок 5.3 — Диаграмма последовательности — Назначение водителя (UC-11)*
...
*Рисунок 5.4 — Диаграмма классов проектирования*
